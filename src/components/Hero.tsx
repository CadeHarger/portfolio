    ...
    >
      ...
      <div className="relative max-w-5xl mx-auto w-full">
        ...
        <p className="text-slate-400 text-lg max-w-xl leading-relaxed mb-10">
          Building high-throughput payment infrastructure and agentic AI systems at{' '}
          <span className="text-slate-200">Deutsche Bank</span>. Passionate about the
          intersection of AI, distributed systems, and developer tooling.
        </p>

        <div className="flex flex-wrap items-center gap-4">
          <a
            href="#experience"
            className="inline-flex items-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-500 text-white text-sm font-medium rounded-lg transition-all hover:shadow-lg hover:shadow-blue-600/25"
          >
            View Experience
